...
<head>
    ...
    <title>Snacks | Cake Island</title>
</head>
<body>
    <header>
        <h1>Snacks</h1>
    <nav>
        <ul>
            ...
            <li class="active"><a href="snacks.php">Snacks</a></li>
    ...
    <main>
        ...
        <section class="d-flex">
            <div>
                <h3>Snacks</h3>
                <p>A snack is a small portion of food generally eaten between meals.</p>
            </div>
            <div>
                <img src="snacks.jpeg" alt="Image of Snacks">
            </div>
        </section>

        <section>
            <label for="snackName">Enter Snacks Name:</label>
    ...
    <script>
        ...
        searchButton.addEventListener("click", function() {
            ...
            if (!searchPattern.test(searchQuery)) {
                ...
                // fetchAndDisplayProductsFromXml("snacks", "all", searchQuery);
                fetchAndDisplayProductsFromDatabase("snacks", "all", searchQuery);
            }
        });
    </script>
</body>
